...
try {
    ...
    & 'C:\Users\map12\Desktop\Proyecto_Adepor\.venv\Scripts\python.exe' 'C:\Users\map12\Desktop\Proyecto_Adepor\scripts\scrape_sofa_backfill_historico.py' --cap 1000 *>&1 | Tee-Object -FilePath $logFile
} catch {
