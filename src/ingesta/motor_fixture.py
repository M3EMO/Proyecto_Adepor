...
from src.comun.adaptadores_odds_api import adaptar_fixture_odds_api
...
def main():
    ...
    global KEY_INDEX
    hoy = datetime.utcnow()
    fechas_a_buscar = [fecha_a_espn(hoy + timedelta(days=i)) for i in range(-1, 6)]
            ...
            try:
                ...
                if pais in MAPA_LIGAS_ODDS and KEY_INDEX < len(API_KEYS_ODDS):
                    ...
                    try:
                        ...
                        eventos_del_dia = [adaptar_fixture_odds_api(ev) for ev in eventos_api_secundaria]
